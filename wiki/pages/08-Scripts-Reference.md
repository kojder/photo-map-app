...
> Complete reference for development scripts - start/stop application, run tests, rebuild, reset data, and install git hooks.

---

## 📖 Introduction

The `scripts/` directory contains utilities for managing the Photo Map MVP development environment. These scripts simplify common tasks like starting/stopping services, running tests, rebuilding the application, and resetting data.

**Key Features:**
- ✅ Automatic PostgreSQL management (starts if not running)
...
**Related Pages:**
- [Development Setup](Development-Setup) - First-time setup and configuration
- [Quick Start](Quick-Start) - Get started in 5 minutes
- [Testing & Quality](Testing-Quality) - Testing strategy and CI/CD
...
- [Development Setup](Development-Setup) - Environment configuration, daily workflow
- [Quick Start](Quick-Start) - Get started in 5 minutes
- [Testing & Quality](Testing-Quality) - Testing strategy, CI/CD pipeline
